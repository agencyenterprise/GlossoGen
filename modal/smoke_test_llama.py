"""Ephemeral smoke test against the deployed Llama 3.3 70B endpoint.

Runs inside a Modal container with the vllm-api-key secret attached so the API
key never leaves Modal. Hits /health, /v1/chat/completions plain, and
...
app = modal.App("llama-3-3-smoke-test")
