...
TOOLS_INTERN = [SEND_MESSAGE_TOOL, MOVE_CONTAINER_TOOL]

MOVE_SUCCESS_MARKER = "MOVE ACCEPTED"
MOVE_REJECTED_MARKER = "MOVE REJECTED"
CONTAINER_PLACED_MARKER = "CONTAINER PLACED"
BUDGET_EXCEEDED_MARKER = "COMMUNICATION BUDGET EXCEEDED"
ROUND_SUCCESS_MARKER = "ROUND SUCCESS"
ROUND_FAILED_MARKER = "ROUND FAILED"

# Default yard size; the active value is the ``yard_slot_count`` knob.
DEFAULT_YARD_SLOT_COUNT = 20
