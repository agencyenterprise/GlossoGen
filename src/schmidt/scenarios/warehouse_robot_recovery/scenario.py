...
from schmidt.scenarios.warehouse_robot_recovery.evaluation import RoundSuccessMetric
...
class WarehouseRobotRecoveryScenario(SimulationScenario):
    ...
    def get_available_metric_names(cls) -> list[str]:
        """Return generic and warehouse-specific metric names."""
