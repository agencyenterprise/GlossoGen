"""Mutable world state for the product launch v2 scenario.
...
from schmidt.scenarios.product_launch_v2.budget_model import BudgetTracker
from schmidt.scenarios.product_launch_v2.dynamics import (
    EXTERNAL_EVENTS,
    BurnoutEvent,
    EffortLevel,
...
from schmidt.scenarios.product_launch_v2.feature_model import Feature, FeatureStatus, QAResult
