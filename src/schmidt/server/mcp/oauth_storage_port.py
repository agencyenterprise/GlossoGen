...
Both the Postgres-backed :class:`~schmidt.server.mcp.oauth_storage.OAuthStorage`
and the :class:`~schmidt.server.mcp.in_memory_oauth_storage.InMemoryOAuthStorage`
