...
from glossogen.scenarios.satellite_contact_window.cases import AuthorizationEnvelope, CommandStep
from glossogen.scenarios.satellite_contact_window.events import SatelliteCommandJudgment
