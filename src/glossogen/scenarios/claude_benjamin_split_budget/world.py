...
_BASE_INSPECTION_MESSAGE = (
    ...
    "reporting enhancement; landing it would add to this window's delivery "
    "total. REQ-88: a configuration cleanup; landing it would add to this "
    "window's delivery total."
)
