"""Launch the frozen shadow-component K1 campaign with live publication."""
...
SCENARIO_NAME = "benjamin_shadow_component"


class K1CampaignManifest(BaseModel):
    """Immutable smoke and K1 matrix for one shadow-component calibration."""
...
async def validate_run_artifact(run_dir: Path) -> RunArtifactValidation:
    """Validate one shadow-component run from its typed JSONL events."""
