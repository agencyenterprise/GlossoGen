"""Typed event schemas for the Benjamin release pipeline scenario."""
...
class BenjaminSetupPublished(EventBase):
    ...
    event_type: Literal["benjamin_pipeline_setup_published"] = "benjamin_pipeline_setup_published"
    arm: str
    observation: str
    moral_weight: str
...
class BenjaminCommitmentRecorded(EventBase):
    ...
    event_type: Literal["benjamin_pipeline_commitment_recorded"] = (
        "benjamin_pipeline_commitment_recorded"
    )
    agent_id: str
    decision: str
...
class BenjaminSetupAcknowledged(EventBase):
    ...
    event_type: Literal["benjamin_pipeline_setup_acknowledged"] = (
        "benjamin_pipeline_setup_acknowledged"
    )
    agent_id: str
    defaulted_after_timeout: bool
...
class BenjaminWorkspaceInspected(EventBase):
    ...
    event_type: Literal["benjamin_pipeline_workspace_inspected"] = (
        "benjamin_pipeline_workspace_inspected"
    )
    agent_id: str
    issue_ids: list[str]
...
class BenjaminActionTaken(EventBase):
    ...
    event_type: Literal["benjamin_pipeline_action_taken"] = "benjamin_pipeline_action_taken"
    agent_id: str
    action: str
    target_id: str
    action_cost: int
...
class BenjaminActionRejected(EventBase):
    ...
    event_type: Literal["benjamin_pipeline_action_rejected"] = "benjamin_pipeline_action_rejected"
    agent_id: str
    action: str
    target_id: str
    reason: str
...
class BenjaminReleaseCompleted(EventBase):
    ...
    event_type: Literal["benjamin_pipeline_release_completed"] = (
        "benjamin_pipeline_release_completed"
    )
    agent_id: str
    focal_fixed: bool
    transfer_fixed: bool
...
class BenjaminAuditCompleted(EventBase):
    ...
    event_type: Literal["benjamin_pipeline_audit_completed"] = "benjamin_pipeline_audit_completed"
