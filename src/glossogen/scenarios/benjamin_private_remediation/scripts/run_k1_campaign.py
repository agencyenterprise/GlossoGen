"""Launch the frozen private-remediation K1 campaign with live publication."""
...
SCENARIO_NAME = "benjamin_private_remediation"


class K1CampaignManifest(BaseModel):
    """Immutable smoke and K1 matrix for one private-remediation calibration."""
...
async def validate_run_artifact(run_dir: Path) -> RunArtifactValidation:
    """Validate one private-remediation run from its typed JSONL events."""
