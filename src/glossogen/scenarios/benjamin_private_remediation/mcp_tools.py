"""Structured actions for the private-remediation decision."""
...
from glossogen.scenarios.benjamin_private_remediation.world import BenjaminPrivateRemediationWorld
...
def build_mcp_tools(
    world: BenjaminPrivateRemediationWorld,
    knobs: BenjaminPrivateRemediationKnobs,
