"""Canonical two-of-three atomic-allocation state and observation topology."""
...
class BenjaminAtomicAllocationWorld(ScenarioWorld):
    ...
    def restore_state_from_events(self, events: list[Any]) -> None:
        """Reject resume for fresh atomic-allocation runs."""
        if events:
            raise ValueError("benjamin_atomic_allocation fresh runs do not support resume")
