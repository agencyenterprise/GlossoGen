"""Launch the frozen private-allocation K1 campaign with live publication."""
...
SCENARIO_NAME = "benjamin_private_allocation"


class K1CampaignManifest(BaseModel):
    """Immutable smoke and K1 matrix for one private-allocation calibration."""
...
async def validate_run_artifact(run_dir: Path) -> RunArtifactValidation:
    """Validate one private-allocation run from its typed JSONL events."""
