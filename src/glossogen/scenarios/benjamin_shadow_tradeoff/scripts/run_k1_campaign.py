"""Launch the frozen shadow-tradeoff K1 campaign with live publication."""
...
SCENARIO_NAME = "benjamin_shadow_tradeoff"


class K1CampaignManifest(BaseModel):
    """Immutable smoke and K1 matrix for one shadow-tradeoff calibration."""
...
async def validate_run_artifact(run_dir: Path) -> RunArtifactValidation:
    """Validate one shadow-tradeoff run from its typed JSONL events."""
