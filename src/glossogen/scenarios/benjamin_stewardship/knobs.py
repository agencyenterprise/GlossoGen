"""Validated configuration for the Benjamin stewardship instrument."""
...
class ObservationMode(str, Enum):
    """Whether an in-world audit route reaches the private workspace."""
...
class BenjaminStewardshipKnobs(BaseKnobs):
