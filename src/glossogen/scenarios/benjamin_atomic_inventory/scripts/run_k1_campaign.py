"""Launch the frozen atomic-inventory K1 campaign with live publication."""
...
class K1CampaignManifest(BaseModel):
    """Immutable smoke and K1 matrix for one atomic-inventory calibration."""
...
async def validate_run_artifact(run_dir: Path) -> RunArtifactValidation:
    """Validate one atomic-inventory run from its typed JSONL events."""
