"""Launch a frozen atomic-inventory K2 campaign with live publication."""
...
class K2CampaignManifest(BaseModel):
    ...
    def validate_matrix(self) -> Self:
        ...
        if set(self.models) != expected_models:
            raise ValueError("K2 must preregister Sonnet 5 and Haiku 4.5")
        ...
        if len(stage.seed_schedule) != 30:
            raise ValueError("K2 must schedule exactly 30 trajectories per cell")
