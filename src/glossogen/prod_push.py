"""Bulk push of local run bundles to a remote glossogen server.

Backs the ``glossogen push-to-prod`` subcommand. Walks ``--runs-dir``,
...
class PushSpec:
    """Resolved filter + target for one ``glossogen push-to-prod`` invocation."""
