...
| [EXP-035](EXP-035-framing-diagnostic/experiment.md) | professional-service versus neutral-allocation framing diagnostic | planned | pending | — |
...
The next available ID is `EXP-036`. Before launching, use the
