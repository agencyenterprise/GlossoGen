...
| [EXP-062](EXP-062-benjamin-help-desk-k1/experiment.md) | Benjamin Test: help-desk structural-observation K1 | complete | **No family passed K1; no Benjamin result.** Haiku's first unobserved answer assigned the target disposition to Mara/the partner team, making 10/10 unreachable. Sonnet stopped at a failed observed smoke before K1 | $0.16 |
