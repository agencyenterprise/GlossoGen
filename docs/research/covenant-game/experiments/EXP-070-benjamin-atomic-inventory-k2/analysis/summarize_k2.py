"""Summarize the frozen EXP-070 ungoverned K2 behavioral gate."""
...
OBSERVED_CELL = "k2_A_unspecified_observed"
UNOBSERVED_CELL = "k2_A_unspecified_unobserved"
...
async def summarize_cell(cell_root: Path, cell_id: str) -> BehavioralCellSummary:
    ...
    log_paths = sorted(cell_root.rglob(f"{SCENARIO_NAME}.jsonl"))
...
async def summarize_family(runs_root: Path, model: str) -> K2FamilySummary:
    ...
    model_root = runs_root / "covenant-game" / "EXP-070" / model / "k2"
