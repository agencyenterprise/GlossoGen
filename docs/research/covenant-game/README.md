...
| [STUDY-020 — Benjamin shared help-desk capacity](studies/STUDY-020-benjamin-help-desk.md) | redesign planned; ticket-disposition instrument retired | Does a named-counterparty covenant flatten observation sensitivity in a real shared-support tradeoff, after K1-K3 pass? |
