...
| [STUDY-026 — Benjamin atomic inventory](studies/STUDY-026-benjamin-atomic-inventory.md) | active — K1 passed; K2 next | Atomic completion and the complete probe schema passed K1 for Sonnet 5 and Haiku 4.5. |
