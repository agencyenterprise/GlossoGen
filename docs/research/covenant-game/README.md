...
| [STUDY-017 — Benjamin artifact-pipeline regeneration](studies/STUDY-017-benjamin-artifact-pipeline.md) | planned; new instrument family | Can agents represent separate processing-system and recipient topology without observation cues, and only then support a Benjamin comparison? |
